...
contract MyBounty {                                             // Declaration of MyBounty contract
    ...
    struct HunterSubmission {                                   // Declaration of HunterSubmission struct type
        address payable hunter;                                         // Address of a Bounty Hunter.
    ...
    */
    function createBounty(string memory _title, string memory _description, uint _bountyAmount) public payable stoppedInEmergency() returns (bool) {
        bountyCount++;
        BountyItem memory newBountyItem = BountyItem(msg.sender, _title, _description, _bountyAmount, BountyState.Open, 0);
    ...
    *   @return boolean             Returns true if function is executes successfully.
    */
    function createSubmission(uint _bountyId, string memory _body) public 
        ...
        returns (bool)
    {
        ...
        HunterSubmission memory newSubmission = HunterSubmission(msg.sender, _body, SubmissionStatus.PendingReview);
